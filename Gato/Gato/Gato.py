...
#Funcion para gaurdar los puntos en el marcador
def Marcador():
...
#Funcion de inicio que abre y le el archivo, despues imprime el menu principal
def Main():
    myline = ""
    global Jugador1Puntaje
    global Jugador2Puntaje
    ...
    if(Eleccion=="1"):
        ...
        Main()
 #Funcion para iniciar el modo de un jugador   
def Uno():
	...
	#Lista para ver las jugadas que se hayan echo y las opciones que tiene la computadora
    ListJugada=[]
...
#Inico del juego 
    while Num>=0:
        while (J1==1):
			#Ingresar tu jugada y revisar que no se haya usado anteriormente
			...
			#Si la jugada no se a ejecutado pasa a remplasar la casilla que le corresponde al jugador
...
#Comienza a revisar si alguna condicion de victoria se cumplio
            ...
            if((ListSuperior==ListR3 or ListSuperior==ListR4 or ListSuperior==ListR5 or ListSuperior==ListR6 or ListSuperior==ListR7 or ListSuperior==ListR8 or ListSuperior==ListR9 or ListSuperior==ListR10) and (ListCentral==ListR11 or ListCentral==ListR12 or ListCentral==ListR13 or ListCentral==ListR14 or ListCentral==ListR15 or ListCentral==ListR16 or ListCentral==ListR17 or ListCentral==ListR18) and (ListInferior==ListR19 or ListInferior==ListR20 or ListInferior==ListR21 or ListInferior==ListR22 or ListInferior==ListR23 or ListInferior==ListR24 or ListInferior==ListR25 or ListInferior==ListR26)):
                ...
                if(Continuar=="SI"):
                    ...
                    print("Grcias por jugar")
                    return
#Aqui terminan las condiciones de victoria                   

#Revisar si las condicion de empate se cumplio
            if(Turno==9):
                print("Es un empate")
                ...
                if (Continuar=="SI"):
                    ...
                    print("Grcias por jugar")
                    return
#inicio del turno de la computadora
        while (Pc==1):
		#elige una jugada al azar y luego lo coloca donde le corresponde
...
#Inicio del juego con dos jugadores
def Dos():
    Nombre1=input("Escriba su nombre J1:")
...
#Inicio del turno del jugador 2
        while (J2==1):
			#Ingresar tu jugada y revisar que no se haya usado anteriormente
